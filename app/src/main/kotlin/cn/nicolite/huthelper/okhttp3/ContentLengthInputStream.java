...
//    }
    ...
    public static InputStream obtain(InputStream other, long contentLength, String task) {
        return new ContentLengthInputStream(other, contentLength, task);
    }
    ...
    ContentLengthInputStream(InputStream in, long contentLength, String task) {
        super(in);
    ...
    private int checkReadSoFarOrThrow(int read) throws IOException {
        ...
        DownloadSchedule.update(task, readSoFar, contentLength);
        return read;
    }
}
