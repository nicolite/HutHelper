...
import cn.nicolite.slideback.util.ViewDragHelper;
...
public class SlidePanel extends FrameLayout {
    ...
    public SlidePanel(Context context, View decorView, SlidrConfig config) {
        super(context);
    ...
    /**
     * Get the default {@link SlideInterface} from which to control the panel with after attachment
     */
    public SlideInterface getDefaultInterface() {
        return defaultSlideInterface;
    }


    private final SlideInterface defaultSlideInterface = new SlideInterface() {


        @Override
        public void lock() {
            SlidePanel.this.lock();
        }


        @Override
        public void unlock() {
            SlidePanel.this.unlock();
        }
    };
