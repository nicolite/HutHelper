...
public class SlidrConfig {
    ...
    private SlidePosition position = SlidePosition.LEFT;
     ...
     */
    public SlidePosition getPosition() {
        return position;
    }
    ...
    public static class Builder {
        ...
        public Builder position(SlidePosition position) {
        ...
        public Builder listener(SlideListener listener) {
